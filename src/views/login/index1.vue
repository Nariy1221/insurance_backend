...
export default {
  ...
  methods: {
    ...
    handleSubmit() {
      ...
      // this.$store.dispatch('submitLogin', this.user).then((response) => {
      ...
      //   this.$store.dispatch('getLoginUserInfo', response.data.token).then((response) => {
      ...
      //       this.$router.options.routes.concat(asyncRoutes)
      //       console.log('-------')
      //       console.log(this.$store.state.isLogin)
      //       console.log('-------')
      //       // var array=constantRoutes.concat(asyncRoutes)
      //       // console.log(array)
