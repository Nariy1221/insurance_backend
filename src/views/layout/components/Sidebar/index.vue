<template>
  <el-scrollbar wrap-class="scrollbar-wrapper">
    <div style="height: 50px;width: 100%;background-color: rgb(40, 89, 67);padding: 10px 0;">
      <el-image :src="require('@/assets/images/footer_logo.png')"></el-image>
    </div>
    <el-menu :show-timeout="200" :default-active="$route.path" :collapse="isCollapse" mode="vertical"
      background-color="#285943" text-color="#D7FFF1" active-text-color="#58C9B9" router="true" icon:true>
...
.el-menu-item.is-active {
  background-color: rgb(32, 71, 54) !important;
}
</style>
